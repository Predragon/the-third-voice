...
Enhanced with logout functionality, copy-to-clipboard feature, and demo user enhancements
"""
...
class UIComponents:
    ...
    def load_custom_css():
        ...
        /* Demo button styling */
        .stButton[data-testid="demo_logout"] > button {
            background-color: #6c757d;
            color: white;
            border: none;
        }
        
        .stButton[data-testid="demo_logout"] > button:hover {
