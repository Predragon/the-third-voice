...
class ThirdVoiceApp:
    ...
    def run(self):
        ...
        if DemoManager.is_demo():
            contacts = [
                {"id": "demo_ex_coparenting", "name": "💔 Sarah (Ex-Wife)", "context": "coparenting",
                ...
                {"id": "demo_current_partner", "name": "💕 Mike (Current Partner)", "context": "romantic",
                ...
                {"id": "demo_difficult_mother", "name": "🏠 Mom", "context": "family",
                ...
                {"id": "demo_workplace_boss", "name": "🏢 Jennifer (Boss)", "context": "workplace",
                 "description": "Your manager who's been unsympathetic about your need for flexible scheduling due to custody arrangements."},
                {"id": "demo_supportive_friend", "name": "🤝 Lisa (Best Friend)", "context": "friend",
