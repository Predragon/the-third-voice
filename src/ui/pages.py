...
class OnboardingFlow:
    """First-time user onboarding - kept for regular users, bypassed for demo"""
    ...
    def run(self, user_id: str, auth_manager) -> bool:
        """Run onboarding flow - bypass for demo users"""
        
        # Skip onboarding for demo users
        if auth_manager.is_demo_user():
            return True
        
        # Initialize onboarding state for regular users
