    ...
    def handle_google_callback(self):
        ...
        if "code" in query_params:
            ...
            try:
                ...
                # Get code_verifier from session state
                ...
                if not code_verifier:
                    st.error("PKCE code verifier not found in session. Please try signing in again.")
                    return None
