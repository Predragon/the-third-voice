...
- Use only these sentiment values: positive, negative, neutral
- Use simple emotional states like: hurt, caring, concerned, worried, frustrated, sad, happy, neutral
    ...
    def process_message(self, message: str, contact_context: str, message_type: str,
        ...
        try:
            ...
            try:
                ...
                ai_data = {
                    "transformed_message": f"Here's a gentler approach: {message}",
                    "healing_score": 4,
                    "sentiment": "neutral",
