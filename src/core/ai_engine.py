...
Please rewrite this to be more compassionate."""
                ...
                user_message = f"""INTERPRET MODE: My {contact_context} sent me this message and I need help understanding what they really mean and how to respond lovingly:

Message they sent me: "{message}"

Please help me understand what they really mean beneath their words and suggest a compassionate response."""
            ...
            try:
                ...
                if message_type == "interpret":
                    ...
                    message_lower = message.lower()
                    if "never" in message_lower and ("call" in message_lower or "phone" in message_lower):
                        ai_data = {
                            "transformed_message": "I hear that you're feeling disconnected from me. I want you to know I value our communication. Can we talk about the best times for me to be available when you call?",
                            "healing_score": 7,
                            "sentiment": "neutral",
                            "emotional_state": "empathetic",
                            "explanation": "They're expressing frustration about feeling disconnected, not just about phone calls",
                            "subtext": "They miss connecting with you and may feel ignored or unimportant",
                            "needs": ["connection", "reliability", "feeling valued"],
                            "warnings": []
                        }
                    elif "frustrated" in message_lower:
                        ai_data = {
                            "transformed_message": "I can hear your frustration, and I want to understand better. Your feelings matter to me. Can we talk about how to improve this together?",
                            "healing_score": 6,
                            "sentiment": "neutral", 
                            "emotional_state": "understanding",
                            "explanation": "They're expressing a deeper need for connection and understanding",
                            "subtext": "Behind the frustration is a desire for better communication",
                            "needs": ["validation", "understanding", "collaboration"],
                            "warnings": []
                        }
                    else:
                        ai_data = {
                            "transformed_message": "I hear you, and I want to understand what you're really feeling. Can you help me know how to support you better?",
                            "healing_score": 5,
                            "sentiment": "neutral",
                            "emotional_state": "caring",
                            "explanation": "They're reaching out because they want connection",
                            "subtext": "There's likely a deeper need beneath their words",
