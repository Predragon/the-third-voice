  ...
  "warnings": ["any red flags to be aware of"]
    ...
    def process_message(self, message: str, contact_context: str, message_type: str,
        ...
        try:
            ...
            # Make the task crystal clear in the user message
            if message_type == MessageType.TRANSFORM.value:
                user_message = f"Please rewrite this message to be more loving and kind while keeping the same meaning: \"{message}\""
            else:
                user_message = f"I received this difficult message and need help understanding it: \"{message}\""
            ...
            try:
                ...
                if message_type == MessageType.TRANSFORM.value:
                    fallback_message = f"I wanted to share something with you: {message}"
                else:
