...
def interpret_message(contact_name, message, context, relationship_history=None):
    ...
    """
    from core_auth_module import make_robust_ai_request
...
def process_message(contact_name, message, context):
    ...
    from core_auth_module import get_current_user_id, supabase, create_message_hash, save_message, make_robust_ai_request
