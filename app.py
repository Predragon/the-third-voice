    ...
    def save_message(self, contact_id: str, contact_name: str, message_type: str,
        ...
        try:
            message_data = {
                ...
                "type": message_type,  # Use the message_type directly (transform/interpret)
                "original": original,
                "result": result,
        ...
        try:
            ...
            for msg_data in response.data:
                messages.append(Message(
                    ...
                    type=msg_data["type"],  # Use the type directly from database
...
CRITICAL: You MUST respond ONLY with valid JSON in the exact format specified below. Do not include any other text, explanations, or markdown formatting."""
...
5. Keep the core message but make it kinder

RESPONSE FORMAT - RESPOND WITH ONLY THIS JSON STRUCTURE:
{
  "transformed_message": "The rewritten message that promotes healing while keeping the original intent",
  "healing_score": 8,
  "sentiment": "positive",
...
Example:
If user says: "You never respond to my messages! I asked you about money and you ignored me!"
You respond with JSON like:
{
  "transformed_message": "Hi, I sent you a message earlier about transferring some money through PayMaya. I haven't heard back and I'm wondering if you received it? I know you're busy, but a quick response would really help put my mind at ease.",
  "healing_score": 7,
  "sentiment": "neutral",
  "emotional_state": "concerned",
  "explanation": "Removed accusatory language, expressed concern instead of anger, made a clear request"
}"""
    ...
    def process_message(self, message: str, contact_context: str, message_type: str,
        ...
        try:
            ...
            try:
                ...
                st.error(f"AI returned invalid response format: {str(e)}")
                # Fallback for non-JSON responses
                ai_data = {
                    "transformed_message": "I'm having trouble processing this message right now. Please try rephrasing your request.",
                    "healing_score": 3,
                    "sentiment": "neutral",
                    "emotional_state": "unclear",
                    "explanation": "AI response format error - please try again"
                }
